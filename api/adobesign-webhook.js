...
export default async function handler(req, res) {
  ...
  if (req.method === "POST") {
    try {
      ...
      const nsResponse = await fetch("https://5001454-sb2.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=3490&deploy=3&compid=5001454_SB2&ns-at=AAEJ7tMQZZn6IQkZMyXCIysJmZMH6lZ_NjohJFbbT8r55KOfnkw", {
       method: "POST",
